...
build/src_core_BasicComposeFunction.o : src/core/BasicComposeFunction.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_core_BasicComposeFunction.o -c src/core/BasicComposeFunction.cpp -Iinclude
...
build/src_core_GPComputePoint.o : src/core/GPComputePoint.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_core_GPComputePoint.o -c src/core/GPComputePoint.cpp -Iinclude
...
build/src_core_IGPAutoDefFunction.o : src/core/IGPAutoDefFunction.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_core_IGPAutoDefFunction.o -c src/core/IGPAutoDefFunction.cpp -Iinclude
...
build/src_optimizor_IGPOptimizor.o : src/optimizor/IGPOptimizor.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_optimizor_IGPOptimizor.o -c src/optimizor/IGPOptimizor.cpp -Iinclude
...
build/src_producer_GPGraphicADF.o : src/producer/GPGraphicADF.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_producer_GPGraphicADF.o -c src/producer/GPGraphicADF.cpp -Iinclude
  
build/src_producer_GPGraphicProducer.o : src/producer/GPGraphicProducer.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_producer_GPGraphicProducer.o -c src/producer/GPGraphicProducer.cpp -Iinclude
  
build/src_producer_GPProducerUtils.o : src/producer/GPProducerUtils.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_producer_GPProducerUtils.o -c src/producer/GPProducerUtils.cpp -Iinclude
  
build/src_producer_GPStreamADF.o : src/producer/GPStreamADF.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_producer_GPStreamADF.o -c src/producer/GPStreamADF.cpp -Iinclude
  
build/src_producer_GPStreamADFProducer.o : src/producer/GPStreamADFProducer.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_producer_GPStreamADFProducer.o -c src/producer/GPStreamADFProducer.cpp -Iinclude
  
build/src_producer_GPTreeADF.o : src/producer/GPTreeADF.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_producer_GPTreeADF.o -c src/producer/GPTreeADF.cpp -Iinclude
  
build/src_producer_GPTreeProducer.o : src/producer/GPTreeProducer.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_producer_GPTreeProducer.o -c src/producer/GPTreeProducer.cpp -Iinclude
  
build/src_producer_recurse_tree.o : src/producer/recurse_tree.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_producer_recurse_tree.o -c src/producer/recurse_tree.cpp -Iinclude
...
build/src_utils_debug.o : src/utils/debug.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_utils_debug.o -c src/utils/debug.cpp -Iinclude
...
build/src_xml_xmlTree.o : src/xml/xmlTree.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_xml_xmlTree.o -c src/xml/xmlTree.cpp -Iinclude
  

ALL_INCLUESlibGP.so= include//core/BasicComposeFunction.h include//core/genetic_operator.h include//core/GP_XmlString.h include//core/GPComputePoint.h include//core/GPFactory.h include//core/GPFunctionDataBase.h include//core/GPMultiTable.h include//core/GPProducer.h include//core/GPStatusContent.h include//core/GPStreamFactory.h include//core/GPStreamUtils.h include//core/group.h include//core/IDataBase.h include//core/IGPAutoDefFunction.h include//evolution/GPEvolutionGroup.h include//GPStrings.h include//head.h include//math/carryArray.h include//math/carryGroup2.h include//math/carryPoint.h include//math/carryTree.h include//math/FormulaTree.h include//math/GPSingleTree.h include//optimizor/GPGoldenDivideOpt.h include//optimizor/GPNetSearchOpt.h include//optimizor/GPOptimizorFactory.h include//optimizor/GPParticleSwarmOpt.h include//optimizor/IGPOptimizor.h include//platform/system_lib.h include//producer/GPGraphicADF.h include//producer/GPGraphicProducer.h include//producer/GPProducerUtils.h include//producer/GPStreamADFProducer.h include//producer/GPTreeADF.h include//producer/GPTreeProducer.h include//user/GPAPI.h include//user/GPContents.h include//user/GPStream.h include//user/IFunctionTable.h include//user/IStatusType.h include//utils/AbstractPoint.h include//utils/AutoClean.h include//utils/AutoStorage.h include//utils/BasicTree.h include//utils/debug.h include//utils/GP_Clock.h include//utils/GPBlock.h include//utils/GPRandom.h include//utils/GPStringHelper.h include//utils/GPTreeNode.h include//utils/RefCount.h include//xml/xmlReader.h include//xml/xmlTree.h

libGP.so:  build/src_core_BasicComposeFunction.o build/src_core_GP_XmlString.o build/src_core_GPComputePoint.o build/src_core_GPFactory.o build/src_core_GPFileStream.o build/src_core_GPFunctionDataBase.o build/src_core_GPMultiTable.o build/src_core_GPStatusContent.o build/src_core_GPStreamFactory.o build/src_core_GPStreamUtils.o build/src_core_GPUserStream.o build/src_core_IGPAutoDefFunction.o build/src_evolution_GPEvolutionGroup.o build/src_GPStrings.o build/src_math_AbstractPoint.o build/src_math_carryArray.o build/src_math_carryPoint.o build/src_math_FormulaTree.o build/src_math_GPSingleTree.o build/src_optimizor_GPGoldenDivideOpt.o build/src_optimizor_GPNetSearchOpt.o build/src_optimizor_GPOptimizorFactory.o build/src_optimizor_GPParticleSwarmOpt.o build/src_optimizor_IGPOptimizor.o build/src_platform_system_lib.o build/src_producer_GPGraphicADF.o build/src_producer_GPGraphicProducer.o build/src_producer_GPProducerUtils.o build/src_producer_GPStreamADF.o build/src_producer_GPStreamADFProducer.o build/src_producer_GPTreeADF.o build/src_producer_GPTreeProducer.o build/src_producer_recurse_tree.o build/src_user_GPAPI.o build/src_utils_debug.o build/src_utils_GP_Clock.o build/src_utils_GPBlock.o build/src_utils_GPRandom.o build/src_utils_GPStringHelper.o build/src_utils_GPTreeNode.o build/src_xml_xmlReader.o build/src_xml_xmlTree.o 
	g++ -std=c++11  -g -fPIC  --shared  -lpthread -ldl -o libGP.so  build/src_core_BasicComposeFunction.o build/src_core_GP_XmlString.o build/src_core_GPComputePoint.o build/src_core_GPFactory.o build/src_core_GPFileStream.o build/src_core_GPFunctionDataBase.o build/src_core_GPMultiTable.o build/src_core_GPStatusContent.o build/src_core_GPStreamFactory.o build/src_core_GPStreamUtils.o build/src_core_GPUserStream.o build/src_core_IGPAutoDefFunction.o build/src_evolution_GPEvolutionGroup.o build/src_GPStrings.o build/src_math_AbstractPoint.o build/src_math_carryArray.o build/src_math_carryPoint.o build/src_math_FormulaTree.o build/src_math_GPSingleTree.o build/src_optimizor_GPGoldenDivideOpt.o build/src_optimizor_GPNetSearchOpt.o build/src_optimizor_GPOptimizorFactory.o build/src_optimizor_GPParticleSwarmOpt.o build/src_optimizor_IGPOptimizor.o build/src_platform_system_lib.o build/src_producer_GPGraphicADF.o build/src_producer_GPGraphicProducer.o build/src_producer_GPProducerUtils.o build/src_producer_GPStreamADF.o build/src_producer_GPStreamADFProducer.o build/src_producer_GPTreeADF.o build/src_producer_GPTreeProducer.o build/src_producer_recurse_tree.o build/src_user_GPAPI.o build/src_utils_debug.o build/src_utils_GP_Clock.o build/src_utils_GPBlock.o build/src_utils_GPRandom.o build/src_utils_GPStringHelper.o build/src_utils_GPTreeNode.o build/src_xml_xmlReader.o build/src_xml_xmlTree.o ${SELF_VARIABLES}

ALL_INCLUEStest.out= include//core/BasicComposeFunction.h include//core/genetic_operator.h include//core/GP_XmlString.h include//core/GPComputePoint.h include//core/GPFactory.h include//core/GPFunctionDataBase.h include//core/GPMultiTable.h include//core/GPProducer.h include//core/GPStatusContent.h include//core/GPStreamFactory.h include//core/GPStreamUtils.h include//core/group.h include//core/IDataBase.h include//core/IGPAutoDefFunction.h include//evolution/GPEvolutionGroup.h include//GPStrings.h include//head.h include//math/carryArray.h include//math/carryGroup2.h include//math/carryPoint.h include//math/carryTree.h include//math/FormulaTree.h include//math/GPSingleTree.h include//optimizor/GPGoldenDivideOpt.h include//optimizor/GPNetSearchOpt.h include//optimizor/GPOptimizorFactory.h include//optimizor/GPParticleSwarmOpt.h include//optimizor/IGPOptimizor.h include//platform/system_lib.h include//producer/GPGraphicADF.h include//producer/GPGraphicProducer.h include//producer/GPProducerUtils.h include//producer/GPStreamADFProducer.h include//producer/GPTreeADF.h include//producer/GPTreeProducer.h include//user/GPAPI.h include//user/GPContents.h include//user/GPStream.h include//user/IFunctionTable.h include//user/IStatusType.h include//utils/AbstractPoint.h include//utils/AutoClean.h include//utils/AutoStorage.h include//utils/BasicTree.h include//utils/debug.h include//utils/GP_Clock.h include//utils/GPBlock.h include//utils/GPRandom.h include//utils/GPStringHelper.h include//utils/GPTreeNode.h include//utils/RefCount.h include//xml/xmlReader.h include//xml/xmlTree.h

test.out:  build/test_AbstractPointTest.o build/test_GPAPITest.o build/test_GPcarryGroupTest.o build/test_GPcombineTest.o build/test_GPFormulaTest.o build/test_GPGoldenDividerTest.o build/test_GPGPDataTest.o build/test_GPGraphicTest.o build/test_GPloadXmlTreeTest.o build/test_GPNetSearchTest.o build/test_GPPSOTest.o build/test_GPSearchIOTest.o build/test_GPSingleTreeTest.o build/test_GPStreamADFTest.o build/test_GPTest.o build/test_GPXmlEvolutionTest.o build/test_main.o libGP.so
	g++ -std=c++11  -g -fPIC   ./libGP.so -lpthread -ldl -o test.out  build/test_AbstractPointTest.o build/test_GPAPITest.o build/test_GPcarryGroupTest.o build/test_GPcombineTest.o build/test_GPFormulaTest.o build/test_GPGoldenDividerTest.o build/test_GPGPDataTest.o build/test_GPGraphicTest.o build/test_GPloadXmlTreeTest.o build/test_GPNetSearchTest.o build/test_GPPSOTest.o build/test_GPSearchIOTest.o build/test_GPSingleTreeTest.o build/test_GPStreamADFTest.o build/test_GPTest.o build/test_GPXmlEvolutionTest.o build/test_main.o ${SELF_VARIABLES}
...
build/test_GPcombineTest.o : test/GPcombineTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -g -fPIC -o build/test_GPcombineTest.o -c test/GPcombineTest.cpp -Iinclude
  
build/test_GPFormulaTest.o : test/GPFormulaTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -g -fPIC -o build/test_GPFormulaTest.o -c test/GPFormulaTest.cpp -Iinclude
...
build/test_GPGPDataTest.o : test/GPGPDataTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -g -fPIC -o build/test_GPGPDataTest.o -c test/GPGPDataTest.cpp -Iinclude
...
build/test_GPloadXmlTreeTest.o : test/GPloadXmlTreeTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -g -fPIC -o build/test_GPloadXmlTreeTest.o -c test/GPloadXmlTreeTest.cpp -Iinclude
...
example.out:  build/simple_main.o libGP.so
	g++ -std=c++11  -g -fPIC   ./libGP.so -ldl -lpthread -o example.out  build/simple_main.o ${SELF_VARIABLES}
...
gptool.out:  build/gptool_main.o libGP.so
	g++ -std=c++11  -g -fPIC   ./libGP.so -ldl -lpthread -o gptool.out  build/gptool_main.o ${SELF_VARIABLES}
build/gptool_main.o : gptool/main.cpp libGP.so  ${ALL_INCLUESgptool.out}
	g++ -std=c++11 -g -fPIC -o build/gptool_main.o -c gptool/main.cpp -Iinclude
...
gpsuit.out:  build/GPSuit_FilePath.o build/GPSuit_main.o libGP.so
	g++ -std=c++11  -g -fPIC   ./libGP.so -o gpsuit.out  build/GPSuit_FilePath.o build/GPSuit_main.o ${SELF_VARIABLES}
build/GPSuit_FilePath.o : GPSuit/FilePath.cpp libGP.so  ${ALL_INCLUESgpsuit.out}
	g++ -std=c++11 -g -fPIC -o build/GPSuit_FilePath.o -c GPSuit/FilePath.cpp -Iinclude
  
build/GPSuit_main.o : GPSuit/main.cpp libGP.so  ${ALL_INCLUESgpsuit.out}
	g++ -std=c++11 -g -fPIC -o build/GPSuit_main.o -c GPSuit/main.cpp -Iinclude
