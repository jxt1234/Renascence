...
build/src_backend_GPBasicKeyIterator_cpp.o : src/backend/GPBasicKeyIterator.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -O3 -g -fPIC -o build/src_backend_GPBasicKeyIterator_cpp.o -c src/backend/GPBasicKeyIterator.cpp -Iinclude
...
build/src_backend_GPKeyIteratorFactory_cpp.o : src/backend/GPKeyIteratorFactory.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -O3 -g -fPIC -o build/src_backend_GPKeyIteratorFactory_cpp.o -c src/backend/GPKeyIteratorFactory.cpp -Iinclude
  
build/src_backend_GPOptimizedKeyIterator_cpp.o : src/backend/GPOptimizedKeyIterator.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -O3 -g -fPIC -o build/src_backend_GPOptimizedKeyIterator_cpp.o -c src/backend/GPOptimizedKeyIterator.cpp -Iinclude
...
build/src_core_GPDefaultType_cpp.o : src/core/GPDefaultType.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -O3 -g -fPIC -o build/src_core_GPDefaultType_cpp.o -c src/core/GPDefaultType.cpp -Iinclude
