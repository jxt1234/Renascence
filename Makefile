...
build/src_backend_GPPiecesMachineFactory.o : src/backend/GPPiecesMachineFactory.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -O3 -g -fPIC -o build/src_backend_GPPiecesMachineFactory.o -c src/backend/GPPiecesMachineFactory.cpp -Iinclude
...
libGP.so:  build/src_backend_GPBasicPiecesFunctionCreator.o build/src_backend_GPComputePoint.o build/src_backend_GPPiecesMachineFactory.o build/src_backend_GPSingleParallelMachine.o build/src_backend_GPStreamADF.o build/src_backend_GPStreamADFProducer.o build/src_backend_GPTreeADF.o build/src_backend_GPTreeProducer.o build/src_core_GPDoubleType.o build/src_core_GPFactory.o build/src_core_GPFileStream.o build/src_core_GPFunctionDataBase.o build/src_core_GPFunctionTree.o build/src_core_GPMultiTable.o build/src_core_GPParameter.o build/src_core_GPPieceFactory.o build/src_core_GPProducer.o build/src_core_GPStatusContent.o build/src_core_GPStreamFactory.o build/src_core_GPStreamUtils.o build/src_core_GPStringType.o build/src_core_GPUserStream.o build/src_evolution_GPEvolutionGroup.o build/src_frontend_GPFormulaTree.o build/src_frontend_GPFunctionFrontEndProducer.o build/src_frontend_GPProducerUtils.o build/src_frontend_recurse_tree.o build/src_GPStrings.o build/src_math_carryArray.o build/src_math_carryPoint.o build/src_math_GPAbstractPoint.o build/src_math_GPCarryVaryGroup.o build/src_math_GPSingleTree.o build/src_math_GPSingleTreeFunction.o build/src_midend_GPMultiLayerTree.o build/src_optimizor_GPGoldenDivideOpt.o build/src_optimizor_GPNetSearchOpt.o build/src_optimizor_GPOptimizorFactory.o build/src_optimizor_GPParticleSwarmOpt.o build/src_platform_system_lib.o build/src_user_GPAPI.o build/src_utils_GPBlock.o build/src_utils_GPClock.o build/src_utils_GPRandom.o build/src_utils_GPStringHelper.o build/src_utils_GPTreeNode.o build/src_xml_xmlReader.o 
	g++ -std=c++11   build/src_backend_GPBasicPiecesFunctionCreator.o build/src_backend_GPComputePoint.o build/src_backend_GPPiecesMachineFactory.o build/src_backend_GPSingleParallelMachine.o build/src_backend_GPStreamADF.o build/src_backend_GPStreamADFProducer.o build/src_backend_GPTreeADF.o build/src_backend_GPTreeProducer.o build/src_core_GPDoubleType.o build/src_core_GPFactory.o build/src_core_GPFileStream.o build/src_core_GPFunctionDataBase.o build/src_core_GPFunctionTree.o build/src_core_GPMultiTable.o build/src_core_GPParameter.o build/src_core_GPPieceFactory.o build/src_core_GPProducer.o build/src_core_GPStatusContent.o build/src_core_GPStreamFactory.o build/src_core_GPStreamUtils.o build/src_core_GPStringType.o build/src_core_GPUserStream.o build/src_evolution_GPEvolutionGroup.o build/src_frontend_GPFormulaTree.o build/src_frontend_GPFunctionFrontEndProducer.o build/src_frontend_GPProducerUtils.o build/src_frontend_recurse_tree.o build/src_GPStrings.o build/src_math_carryArray.o build/src_math_carryPoint.o build/src_math_GPAbstractPoint.o build/src_math_GPCarryVaryGroup.o build/src_math_GPSingleTree.o build/src_math_GPSingleTreeFunction.o build/src_midend_GPMultiLayerTree.o build/src_optimizor_GPGoldenDivideOpt.o build/src_optimizor_GPNetSearchOpt.o build/src_optimizor_GPOptimizorFactory.o build/src_optimizor_GPParticleSwarmOpt.o build/src_platform_system_lib.o build/src_user_GPAPI.o build/src_utils_GPBlock.o build/src_utils_GPClock.o build/src_utils_GPRandom.o build/src_utils_GPStringHelper.o build/src_utils_GPTreeNode.o build/src_xml_xmlReader.o -O3 -g -fPIC  --shared  -lpthread -ldl -o libGP.so ${SELF_VARIABLES}
