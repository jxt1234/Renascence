...
build/test_main.o : src/test/main.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -o build/test_main.o -c src/test/main.cpp -Iinclude 
build/test_GPcombineTest.o : src/test/GPcombineTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -o build/test_GPcombineTest.o -c src/test/GPcombineTest.cpp -Iinclude 
build/test_AbstractPointTest.o : src/test/AbstractPointTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -o build/test_AbstractPointTest.o -c src/test/AbstractPointTest.cpp -Iinclude 
build/test_GPXmlEvolutionTest.o : src/test/GPXmlEvolutionTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -o build/test_GPXmlEvolutionTest.o -c src/test/GPXmlEvolutionTest.cpp -Iinclude 
build/test_GPSingleTreeTest.o : src/test/GPSingleTreeTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -o build/test_GPSingleTreeTest.o -c src/test/GPSingleTreeTest.cpp -Iinclude 
build/test_GPloadXmlTreeTest.o : src/test/GPloadXmlTreeTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -o build/test_GPloadXmlTreeTest.o -c src/test/GPloadXmlTreeTest.cpp -Iinclude 
build/test_GPGPDataTest.o : src/test/GPGPDataTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -o build/test_GPGPDataTest.o -c src/test/GPGPDataTest.cpp -Iinclude 
build/test_GPTest.o : src/test/GPTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -o build/test_GPTest.o -c src/test/GPTest.cpp -Iinclude 
build/test_GPxmlTreeTest.o : src/test/GPxmlTreeTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -o build/test_GPxmlTreeTest.o -c src/test/GPxmlTreeTest.cpp -Iinclude 
build/test_GPSearchIOTest.o : src/test/GPSearchIOTest.cpp libGP.so  ${ALL_INCLUEStest.out}
...
build/GPSuit_main.o : src/GPSuit/main.cpp libGP.so  ${ALL_INCLUESgpsuit.out}
	g++ -O3 -o build/GPSuit_main.o -c src/GPSuit/main.cpp -Iinclude 
build/GPSuit_FilePath.o : src/GPSuit/FilePath.cpp libGP.so  ${ALL_INCLUESgpsuit.out}
