...
GP_MAIN:  build/test_AbstractPointTest.o build/math_carryPoint.o build/math_carryArray.o build/api_evolution.o build/platform_system_lib.o build/core_GeneticProgram.o build/core_GPRunable.o build/core_GP_XmlString.o build/core_status.o build/core_evolutionTreeV2.o build/core_AbstractGP.o build/core_function.o build/xml_xmlFunctionLoader.o build/xml_xmlReader.o build/xml_xmlGPLoader.o build/utils_GP_Clock.o build/utils_statusMachine.o build/algorithm_AbstractPoint.o build/systems_GenerateSystem.o build/systems_recurse_tree.o build/systems_computeSystem.o build/systems_xmlDataBase.o build/systems_xmlGenerateSystem.o build/main.o build/utils_debug.o
	g++  -O3  -o GP_MAIN  build/test_AbstractPointTest.o build/math_carryPoint.o build/math_carryArray.o build/api_evolution.o build/platform_system_lib.o build/core_GeneticProgram.o build/core_GPRunable.o build/core_GP_XmlString.o build/core_status.o build/core_evolutionTreeV2.o build/core_AbstractGP.o build/core_function.o build/xml_xmlFunctionLoader.o build/xml_xmlReader.o build/xml_xmlGPLoader.o build/utils_GP_Clock.o build/utils_statusMachine.o build/algorithm_AbstractPoint.o build/systems_GenerateSystem.o build/systems_recurse_tree.o build/systems_computeSystem.o build/systems_xmlDataBase.o build/systems_xmlGenerateSystem.o build/main.o build/utils_debug.o -ldl 
