include make.self
ALL_INCLUES= include/test/GPTest.h include/math/AbstractPoint.h include/math/carryTree.h include/math/carryArray.h include/math/carryPoint.h include/api/evolution.h include/system/xmlDataBase.h include/system/GenerateSystem.h include/system/recurse_tree.h include/system/computeSystem.h include/system/system_lib.h include/system/xmlGenerateSystem.h include/evolution/evolutionTree.h include/core/status.h include/core/AbstractGP.h include/core/genetic_operator.h include/core/GP_XmlString.h include/core/IDataBase.h include/core/function.h include/core/IGPAutoDefFunction.h include/core/group.h include/core/functionDataBase.h include/core/computeTree.h include/xml/xmlFunctionLoader.h include/xml/xmlGPLoader.h include/xml/xmlReader.h include/utils/statusMachine.h include/utils/BasicTree.h include/utils/debug.h include/utils/GP_Clock.h include/user/IFunctionTable.h include/user/package.h
all: GP_MAIN libGP.so 
GP_MAIN:  build/test_AbstractPointTest.o build/test_GPEvolutionTest.o build/test_GPInputTest.o build/test_GPTest.o build/test_GPRunTest.o build/math_AbstractPoint.o build/math_carryPoint.o build/math_carryArray.o build/api_evolution.o build/platform_system_lib.o build/evolution_evolutionTree.o build/core_GP_XmlString.o build/core_status.o build/core_AbstractGP.o build/core_function.o build/xml_xmlFunctionLoader.o build/xml_xmlReader.o build/xml_xmlGPLoader.o build/utils_GP_Clock.o build/utils_statusMachine.o build/systems_GenerateSystem.o build/systems_recurse_tree.o build/systems_computeSystem.o build/systems_xmlDataBase.o build/systems_xmlGenerateSystem.o build/main.o build/utils_debug.o
	g++  -O3 -o GP_MAIN  build/test_AbstractPointTest.o build/test_GPEvolutionTest.o build/test_GPInputTest.o build/test_GPTest.o build/test_GPRunTest.o build/math_AbstractPoint.o build/math_carryPoint.o build/math_carryArray.o build/api_evolution.o build/platform_system_lib.o build/evolution_evolutionTree.o build/core_GP_XmlString.o build/core_status.o build/core_AbstractGP.o build/core_function.o build/xml_xmlFunctionLoader.o build/xml_xmlReader.o build/xml_xmlGPLoader.o build/utils_GP_Clock.o build/utils_statusMachine.o build/systems_GenerateSystem.o build/systems_recurse_tree.o build/systems_computeSystem.o build/systems_xmlDataBase.o build/systems_xmlGenerateSystem.o build/main.o build/utils_debug.o  ${SELF_VARIABLES}
libGP.so:  build/test_AbstractPointTest.o build/test_GPEvolutionTest.o build/test_GPInputTest.o build/test_GPTest.o build/test_GPRunTest.o build/math_AbstractPoint.o build/math_carryPoint.o build/math_carryArray.o build/api_evolution.o build/platform_system_lib.o build/evolution_evolutionTree.o build/core_GP_XmlString.o build/core_status.o build/core_AbstractGP.o build/core_function.o build/xml_xmlFunctionLoader.o build/xml_xmlReader.o build/xml_xmlGPLoader.o build/utils_GP_Clock.o build/utils_statusMachine.o build/systems_GenerateSystem.o build/systems_recurse_tree.o build/systems_computeSystem.o build/systems_xmlDataBase.o build/systems_xmlGenerateSystem.o build/main.o build/utils_debug.o
	g++  -O3 --share  -o libGP.so  build/test_AbstractPointTest.o build/test_GPEvolutionTest.o build/test_GPInputTest.o build/test_GPTest.o build/test_GPRunTest.o build/math_AbstractPoint.o build/math_carryPoint.o build/math_carryArray.o build/api_evolution.o build/platform_system_lib.o build/evolution_evolutionTree.o build/core_GP_XmlString.o build/core_status.o build/core_AbstractGP.o build/core_function.o build/xml_xmlFunctionLoader.o build/xml_xmlReader.o build/xml_xmlGPLoader.o build/utils_GP_Clock.o build/utils_statusMachine.o build/systems_GenerateSystem.o build/systems_recurse_tree.o build/systems_computeSystem.o build/systems_xmlDataBase.o build/systems_xmlGenerateSystem.o build/main.o build/utils_debug.o  ${SELF_VARIABLES}
...
build/test_GPInputTest.o : src/test/GPInputTest.cpp ${ALL_INCLUES}
	g++ -O3 -o build/test_GPInputTest.o -c src/test/GPInputTest.cpp -Iinclude 
