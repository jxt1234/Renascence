...
build/src_core_GPProducer.o : src/core/GPProducer.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -O3 -fPIC -o build/src_core_GPProducer.o -c src/core/GPProducer.cpp -Iinclude
