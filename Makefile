...
build/src_core_GPMemStream.o : src/core/GPMemStream.cpp   ${ALL_INCLUESlibGP.a}
	g++ -std=c++11 -g -fPIC -o build/src_core_GPMemStream.o -c src/core/GPMemStream.cpp -Iinclude
