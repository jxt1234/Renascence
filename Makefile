...
test.out:  build/test_AbstractPointTest.o build/test_GPAPITest.o build/test_GPcarryGroupTest.o build/test_GPFormulaADFTest.o build/test_GPFormulaTreeTest.o build/test_GPGoldenDividerTest.o build/test_GPMultiLayerTreeTest.o build/test_GPNetSearchTest.o build/test_GPPSOTest.o build/test_GPSearchIOTest.o build/test_GPStreamADFTest.o build/test_GPTest.o build/test_GPTreeProducerTest.o build/test_GPXmlEvolutionTest.o build/test_main.o libGP.so
	g++ -std=c++11   build/test_AbstractPointTest.o build/test_GPAPITest.o build/test_GPcarryGroupTest.o build/test_GPFormulaADFTest.o build/test_GPFormulaTreeTest.o build/test_GPGoldenDividerTest.o build/test_GPMultiLayerTreeTest.o build/test_GPNetSearchTest.o build/test_GPPSOTest.o build/test_GPSearchIOTest.o build/test_GPStreamADFTest.o build/test_GPTest.o build/test_GPTreeProducerTest.o build/test_GPXmlEvolutionTest.o build/test_main.o -O3 -g -fPIC   ./libGP.so -lpthread -ldl -o test.out ${SELF_VARIABLES}
