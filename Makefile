...
build/core_evolutionTree.o : src/core/evolutionTree.cpp ${ALL_INCLUES}
	g++  -O3  -o build/core_evolutionTree.o -c src/core/evolutionTree.cpp -Iinclude 
