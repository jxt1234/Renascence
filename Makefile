...
build/src_core_GPComputePoint.o : src/core/GPComputePoint.cpp   ${ALL_INCLUESlibGP.so}
	g++ -std=c++11 -O3 -fPIC -o build/src_core_GPComputePoint.o -c src/core/GPComputePoint.cpp -Iinclude
