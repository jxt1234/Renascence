all:libGP.so GP_MAIN 

ALL_INCLUESlibGP.so= include/core/status.h include/core/AbstractGP.h include/core/SingleTree.h include/core/funcStatusType.h include/core/genetic_operator.h include/core/GP_XmlString.h include/core/IDataBase.h include/core/function.h include/core/IGPAutoDefFunction.h include/core/group.h include/core/GPProducer.h include/core/computeTree.h include/system/xmlDataBase.h include/system/GenerateSystem.h include/system/recurse_tree.h include/system/computeSystem.h include/system/system_lib.h include/system/xmlGenerateSystem.h include/api/evolution.h include/evolution/mutateTree.h include/evolution/evolutionTree.h include/math/AbstractPoint.h include/math/carryTree.h include/math/carryArray.h include/math/carryPoint.h include/utils/statusMachine.h include/utils/BasicTree.h include/utils/debug.h include/utils/GP_Clock.h include/xml/xmlFunctionLoader.h include/xml/xmlGPLoader.h include/xml/xmlReader.h include/xml/xmlTree.h

libGP.so:  build/core_GP_XmlString.o build/core_status.o build/core_GPProducer.o build/core_AbstractGP.o build/core_function.o build/core_funcStatusType.o build/system_GenerateSystem.o build/system_recurse_tree.o build/system_computeSystem.o build/system_system_lib.o build/system_xmlDataBase.o build/system_xmlGenerateSystem.o build/platform_system_lib.o build/api_evolution.o build/evolution_evolutionTree.o build/evolution_mutateTree.o build/math_AbstractPoint.o build/math_carryPoint.o build/math_carryArray.o build/utils_GP_Clock.o build/utils_statusMachine.o build/xml_xmlFunctionLoader.o build/xml_xmlReader.o build/xml_xmlGPLoader.o build/xml_xmlTree.o build/utils_debug.o 
	g++  -O3 --share  -o libGP.so  build/core_GP_XmlString.o build/core_status.o build/core_GPProducer.o build/core_AbstractGP.o build/core_function.o build/core_funcStatusType.o build/system_GenerateSystem.o build/system_recurse_tree.o build/system_computeSystem.o build/system_system_lib.o build/system_xmlDataBase.o build/system_xmlGenerateSystem.o build/platform_system_lib.o build/api_evolution.o build/evolution_evolutionTree.o build/evolution_mutateTree.o build/math_AbstractPoint.o build/math_carryPoint.o build/math_carryArray.o build/utils_GP_Clock.o build/utils_statusMachine.o build/xml_xmlFunctionLoader.o build/xml_xmlReader.o build/xml_xmlGPLoader.o build/xml_xmlTree.o build/utils_debug.o  -lpthread -ldl ${SELF_VARIABLES}
...
GP_MAIN:  build/test_AbstractPointTest.o build/test_GPEvolutionTest.o build/test_GPloadXmlTreeTest.o build/test_GPTest.o build/test_GPxmlTreeTest.o build/test_GPSearchIOTest.o build/test_GPRunTest.o build/main.o libGP.so
	g++  -O3 -o GP_MAIN  build/test_AbstractPointTest.o build/test_GPEvolutionTest.o build/test_GPloadXmlTreeTest.o build/test_GPTest.o build/test_GPxmlTreeTest.o build/test_GPSearchIOTest.o build/test_GPRunTest.o build/main.o  ./libGP.so -ldl -lpthread  ${SELF_VARIABLES}
...
build/test_GPloadXmlTreeTest.o : src/test/GPloadXmlTreeTest.cpp ${ALL_INCLUESGP_MAIN}
	g++ -O3 -o build/test_GPloadXmlTreeTest.o -c src/test/GPloadXmlTreeTest.cpp -Iinclude 
build/test_GPTest.o : src/test/GPTest.cpp ${ALL_INCLUESGP_MAIN}
	g++ -O3 -o build/test_GPTest.o -c src/test/GPTest.cpp -Iinclude 
build/test_GPxmlTreeTest.o : src/test/GPxmlTreeTest.cpp ${ALL_INCLUESGP_MAIN}
	g++ -O3 -o build/test_GPxmlTreeTest.o -c src/test/GPxmlTreeTest.cpp -Iinclude 
build/test_GPSearchIOTest.o : src/test/GPSearchIOTest.cpp ${ALL_INCLUESGP_MAIN}
	g++ -O3 -o build/test_GPSearchIOTest.o -c src/test/GPSearchIOTest.cpp -Iinclude 
build/test_GPRunTest.o : src/test/GPRunTest.cpp ${ALL_INCLUESGP_MAIN}
	g++ -O3 -o build/test_GPRunTest.o -c src/test/GPRunTest.cpp -Iinclude 
build/main.o : ./main.cpp ${ALL_INCLUESGP_MAIN}
