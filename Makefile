...
ALL_INCLUESlibGP.so= include/core/status.h include/core/AbstractGP.h include/core/GPProducerFactory.h include/core/funcStatusType.h include/core/genetic_operator.h include/core/GP_XmlString.h include/core/IDataBase.h include/core/BasicComposeFunction.h include/core/function.h include/core/GPData.h include/core/IGPAutoDefFunction.h include/core/group.h include/core/GPProducer.h include/core/computeTree.h include/system/xmlDataBase.h include/system/GenerateSystem.h include/system/recurse_tree.h include/system/computeSystem.h include/system/system_lib.h include/system/xmlGenerateSystem.h include/api/evolution.h include/evolution/GPEvolutionGroup.h include/evolution/mutateTree.h include/evolution/AbstractEvolutionGroup.h include/evolution/evolutionTree.h include/math/AbstractPoint.h include/math/carryTree.h include/math/carryArray.h include/math/carryPoint.h include/math/GPSingleTree.h include/utils/statusMachine.h include/utils/RefCount.h include/utils/AutoClean.h include/utils/BasicTree.h include/utils/debug.h include/utils/GP_Clock.h include/xml/xmlGPDataLoader.h include/xml/xmlFunctionLoader.h include/xml/xmlGPLoader.h include/xml/xmlReader.h include/xml/xmlTree.h

libGP.so:  build/core_BasicComposeFunction.o build/core_GPData.o build/core_GPProducerFactory.o build/core_GP_XmlString.o build/core_status.o build/core_GPProducer.o build/core_AbstractGP.o build/core_function.o build/core_funcStatusType.o build/system_GenerateSystem.o build/system_recurse_tree.o build/system_computeSystem.o build/system_system_lib.o build/system_xmlDataBase.o build/system_xmlGenerateSystem.o build/platform_system_lib.o build/api_evolution.o build/evolution_GPEvolutionGroup.o build/evolution_evolutionTree.o build/evolution_mutateTree.o build/math_GPSingleTree.o build/math_AbstractPoint.o build/math_carryPoint.o build/math_carryArray.o build/utils_GP_Clock.o build/utils_statusMachine.o build/xml_xmlFunctionLoader.o build/xml_xmlReader.o build/xml_xmlGPDataLoader.o build/xml_xmlGPLoader.o build/xml_xmlTree.o build/utils_debug.o 
	g++  -O3 --share  -o libGP.so  build/core_BasicComposeFunction.o build/core_GPData.o build/core_GPProducerFactory.o build/core_GP_XmlString.o build/core_status.o build/core_GPProducer.o build/core_AbstractGP.o build/core_function.o build/core_funcStatusType.o build/system_GenerateSystem.o build/system_recurse_tree.o build/system_computeSystem.o build/system_system_lib.o build/system_xmlDataBase.o build/system_xmlGenerateSystem.o build/platform_system_lib.o build/api_evolution.o build/evolution_GPEvolutionGroup.o build/evolution_evolutionTree.o build/evolution_mutateTree.o build/math_GPSingleTree.o build/math_AbstractPoint.o build/math_carryPoint.o build/math_carryArray.o build/utils_GP_Clock.o build/utils_statusMachine.o build/xml_xmlFunctionLoader.o build/xml_xmlReader.o build/xml_xmlGPDataLoader.o build/xml_xmlGPLoader.o build/xml_xmlTree.o build/utils_debug.o  -lpthread -ldl ${SELF_VARIABLES}
...
test.out:  build/test_main.o build/test_GPcombineTest.o build/test_AbstractPointTest.o build/test_GPloadXmlTreeTest2.o build/test_GPXmlEvolutionTest.o build/test_GPEvolutionTest.o build/test_GPSingleTreeTest.o build/test_GPloadXmlTreeTest.o build/test_GPGPDataTest.o build/test_GPTest.o build/test_GPxmlTreeTest.o build/test_GPSearchIOTest.o build/test_GPRunTest.o libGP.so
	g++  -O3 -o test.out  build/test_main.o build/test_GPcombineTest.o build/test_AbstractPointTest.o build/test_GPloadXmlTreeTest2.o build/test_GPXmlEvolutionTest.o build/test_GPEvolutionTest.o build/test_GPSingleTreeTest.o build/test_GPloadXmlTreeTest.o build/test_GPGPDataTest.o build/test_GPTest.o build/test_GPxmlTreeTest.o build/test_GPSearchIOTest.o build/test_GPRunTest.o  ./libGP.so -ldl -lpthread  ${SELF_VARIABLES}
