...
build/evolution_xmlEvolutionGroup.o : src/evolution/xmlEvolutionGroup.cpp ${ALL_INCLUESlibGP.so}
	g++ -O3 -o build/evolution_xmlEvolutionGroup.o -c src/evolution/xmlEvolutionGroup.cpp -Iinclude 
