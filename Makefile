...
build/systems_statusSystem.o : src/systems/statusSystem.cpp ${ALL_INCLUES}
	g++  -O3  -o build/systems_statusSystem.o -c src/systems/statusSystem.cpp -Iinclude 
