...
TEST:  build/test_AbstractPointTest.o build/test_GPloadXmlTreeTest2.o build/test_GPXmlEvolutionTest.o build/test_GPEvolutionTest.o build/test_GPloadXmlTreeTest.o build/test_GPGPDataTest.o build/test_GPTest.o build/test_GPxmlTreeTest.o build/test_GPSearchIOTest.o build/test_GPRunTest.o build/main.o libGP.so
