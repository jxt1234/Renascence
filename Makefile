...
ALL_INCLUESlibGP.so= include/math/carryGroup2.h include/math/AbstractPoint.h include/math/carryTree.h include/math/carryArray.h include/math/carryPoint.h include/math/GPSingleTree.h include/math/FormulaTree.h include/optimizor/GPOptimizorFactory.h include/optimizor/GPGoldenDivideOpt.h include/optimizor/IGPOptimizor.h include/optimizor/GPNetSearchOpt.h include/optimizor/GPParticleSwarmOpt.h include/system/system_lib.h include/evolution/GPFunctionFitcomputer.h include/evolution/GPEvolutionGroup.h include/evolution/IGPADFOptimizor.h include/evolution/GPADFOptimizorFactory.h include/evolution/GPSingleOptimizor.h include/core/xmlGPDataLoader.h include/core/GPFactory.h include/core/GPFunctionDataBase.h include/core/GPStatusContent.h include/core/genetic_operator.h include/core/GP_XmlString.h include/core/IDataBase.h include/core/BasicComposeFunction.h include/core/function.h include/core/GPData.h include/core/IGPAutoDefFunction.h include/core/group.h include/core/GPProducer.h include/xml/xmlReader.h include/xml/xmlTree.h include/producer/GPTreeProducer.h include/producer/GPTreeADF.h include/producer/GPGraphicProducer.h include/producer/GPGraphicADF.h include/utils/statusMachine.h include/utils/AutoStorage.h include/utils/RefCount.h include/utils/AutoClean.h include/utils/BasicTree.h include/utils/debug.h include/utils/GP_Clock.h include/utils/GPRandom.h include/head.h include/user/status.h include/user/IFunctionTable.h include/user/package.h

libGP.so:  build/src_math_GPSingleTree.o build/src_math_AbstractPoint.o build/src_math_carryPoint.o build/src_math_carryArray.o build/src_math_FormulaTree.o build/src_optimizor_GPParticleSwarmOpt.o build/src_optimizor_GPGoldenDivideOpt.o build/src_optimizor_GPOptimizorFactory.o build/src_optimizor_IGPOptimizor.o build/src_optimizor_GPNetSearchOpt.o build/src_system_system_lib.o build/src_platform_system_lib.o build/src_evolution_GPSingleOptimizor.o build/src_evolution_GPADFOptimizorFactory.o build/src_evolution_GPEvolutionGroup.o build/src_evolution_GPFunctoinFitcomputer.o build/src_core_GPStatusContent.o build/src_core_BasicComposeFunction.o build/src_core_GPData.o build/src_core_GP_XmlString.o build/src_core_GPFactory.o build/src_core_xmlGPDataLoader.o build/src_core_function.o build/src_core_GPFunctionDataBase.o build/src_xml_xmlReader.o build/src_xml_xmlTree.o build/src_producer_GPTreeProducer.o build/src_producer_recurse_tree.o build/src_producer_GPGraphicProducer.o build/src_producer_GPTreeADF.o build/src_producer_GPGraphicADF.o build/src_producer_GPSearchTree.o build/src_utils_GP_Clock.o build/src_utils_GPRandom.o build/src_utils_statusMachine.o build/src_utils_debug.o 
	g++  -O3 -fPIC --share  -o libGP.so  build/src_math_GPSingleTree.o build/src_math_AbstractPoint.o build/src_math_carryPoint.o build/src_math_carryArray.o build/src_math_FormulaTree.o build/src_optimizor_GPParticleSwarmOpt.o build/src_optimizor_GPGoldenDivideOpt.o build/src_optimizor_GPOptimizorFactory.o build/src_optimizor_IGPOptimizor.o build/src_optimizor_GPNetSearchOpt.o build/src_system_system_lib.o build/src_platform_system_lib.o build/src_evolution_GPSingleOptimizor.o build/src_evolution_GPADFOptimizorFactory.o build/src_evolution_GPEvolutionGroup.o build/src_evolution_GPFunctoinFitcomputer.o build/src_core_GPStatusContent.o build/src_core_BasicComposeFunction.o build/src_core_GPData.o build/src_core_GP_XmlString.o build/src_core_GPFactory.o build/src_core_xmlGPDataLoader.o build/src_core_function.o build/src_core_GPFunctionDataBase.o build/src_xml_xmlReader.o build/src_xml_xmlTree.o build/src_producer_GPTreeProducer.o build/src_producer_recurse_tree.o build/src_producer_GPGraphicProducer.o build/src_producer_GPTreeADF.o build/src_producer_GPGraphicADF.o build/src_producer_GPSearchTree.o build/src_utils_GP_Clock.o build/src_utils_GPRandom.o build/src_utils_statusMachine.o build/src_utils_debug.o  -lpthread -ldl ${SELF_VARIABLES}
...
build/src_optimizor_GPParticleSwarmOpt.o : src/optimizor/GPParticleSwarmOpt.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_optimizor_GPParticleSwarmOpt.o -c src/optimizor/GPParticleSwarmOpt.cpp -Iinclude 
build/src_optimizor_GPGoldenDivideOpt.o : src/optimizor/GPGoldenDivideOpt.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_optimizor_GPGoldenDivideOpt.o -c src/optimizor/GPGoldenDivideOpt.cpp -Iinclude 
build/src_optimizor_GPOptimizorFactory.o : src/optimizor/GPOptimizorFactory.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_optimizor_GPOptimizorFactory.o -c src/optimizor/GPOptimizorFactory.cpp -Iinclude 
build/src_optimizor_IGPOptimizor.o : src/optimizor/IGPOptimizor.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_optimizor_IGPOptimizor.o -c src/optimizor/IGPOptimizor.cpp -Iinclude 
build/src_optimizor_GPNetSearchOpt.o : src/optimizor/GPNetSearchOpt.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_optimizor_GPNetSearchOpt.o -c src/optimizor/GPNetSearchOpt.cpp -Iinclude 
...
build/src_evolution_GPSingleOptimizor.o : src/evolution/GPSingleOptimizor.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_evolution_GPSingleOptimizor.o -c src/evolution/GPSingleOptimizor.cpp -Iinclude 
build/src_evolution_GPADFOptimizorFactory.o : src/evolution/GPADFOptimizorFactory.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_evolution_GPADFOptimizorFactory.o -c src/evolution/GPADFOptimizorFactory.cpp -Iinclude 
...
build/src_evolution_GPFunctoinFitcomputer.o : src/evolution/GPFunctoinFitcomputer.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_evolution_GPFunctoinFitcomputer.o -c src/evolution/GPFunctoinFitcomputer.cpp -Iinclude 
build/src_core_GPStatusContent.o : src/core/GPStatusContent.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_core_GPStatusContent.o -c src/core/GPStatusContent.cpp -Iinclude 
...
build/src_core_GPFactory.o : src/core/GPFactory.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_core_GPFactory.o -c src/core/GPFactory.cpp -Iinclude 
build/src_core_xmlGPDataLoader.o : src/core/xmlGPDataLoader.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_core_xmlGPDataLoader.o -c src/core/xmlGPDataLoader.cpp -Iinclude 
...
build/src_producer_GPTreeProducer.o : src/producer/GPTreeProducer.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_producer_GPTreeProducer.o -c src/producer/GPTreeProducer.cpp -Iinclude 
build/src_producer_recurse_tree.o : src/producer/recurse_tree.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_producer_recurse_tree.o -c src/producer/recurse_tree.cpp -Iinclude 
build/src_producer_GPGraphicProducer.o : src/producer/GPGraphicProducer.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_producer_GPGraphicProducer.o -c src/producer/GPGraphicProducer.cpp -Iinclude 
build/src_producer_GPTreeADF.o : src/producer/GPTreeADF.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_producer_GPTreeADF.o -c src/producer/GPTreeADF.cpp -Iinclude 
build/src_producer_GPGraphicADF.o : src/producer/GPGraphicADF.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_producer_GPGraphicADF.o -c src/producer/GPGraphicADF.cpp -Iinclude 
build/src_producer_GPSearchTree.o : src/producer/GPSearchTree.cpp   ${ALL_INCLUESlibGP.so}
	g++ -O3 -fPIC -o build/src_producer_GPSearchTree.o -c src/producer/GPSearchTree.cpp -Iinclude 
...
ALL_INCLUEStest.out= include/math/carryGroup2.h include/math/AbstractPoint.h include/math/carryTree.h include/math/carryArray.h include/math/carryPoint.h include/math/GPSingleTree.h include/math/FormulaTree.h include/optimizor/GPOptimizorFactory.h include/optimizor/GPGoldenDivideOpt.h include/optimizor/IGPOptimizor.h include/optimizor/GPNetSearchOpt.h include/optimizor/GPParticleSwarmOpt.h include/system/system_lib.h include/evolution/GPFunctionFitcomputer.h include/evolution/GPEvolutionGroup.h include/evolution/IGPADFOptimizor.h include/evolution/GPADFOptimizorFactory.h include/evolution/GPSingleOptimizor.h include/core/xmlGPDataLoader.h include/core/GPFactory.h include/core/GPFunctionDataBase.h include/core/GPStatusContent.h include/core/genetic_operator.h include/core/GP_XmlString.h include/core/IDataBase.h include/core/BasicComposeFunction.h include/core/function.h include/core/GPData.h include/core/IGPAutoDefFunction.h include/core/group.h include/core/GPProducer.h include/xml/xmlReader.h include/xml/xmlTree.h include/producer/GPTreeProducer.h include/producer/GPTreeADF.h include/producer/GPGraphicProducer.h include/producer/GPGraphicADF.h include/utils/statusMachine.h include/utils/AutoStorage.h include/utils/RefCount.h include/utils/AutoClean.h include/utils/BasicTree.h include/utils/debug.h include/utils/GP_Clock.h include/utils/GPRandom.h include/head.h include/user/status.h include/user/IFunctionTable.h include/user/package.h

test.out:  build/test_main.o build/test_GPcombineTest.o build/test_AbstractPointTest.o build/test_GPXmlEvolutionTest.o build/test_GPSingleTreeTest.o build/test_GPloadXmlTreeTest.o build/test_GPGPDataTest.o build/test_GPGraphicTest.o build/test_GPFormulaTest.o build/test_GPGoldenDividerTest.o build/test_GPTest.o build/test_GPxmlTreeTest.o build/test_GPNetSearchTest.o build/test_GPSearchIOTest.o build/test_GPPSOTest.o build/test_GPSingleFunctionOptTest.o libGP.so
...
build/test_GPFormulaTest.o : test/GPFormulaTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -fPIC -o build/test_GPFormulaTest.o -c test/GPFormulaTest.cpp -Iinclude 
build/test_GPGoldenDividerTest.o : test/GPGoldenDividerTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -fPIC -o build/test_GPGoldenDividerTest.o -c test/GPGoldenDividerTest.cpp -Iinclude 
...
build/test_GPNetSearchTest.o : test/GPNetSearchTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -fPIC -o build/test_GPNetSearchTest.o -c test/GPNetSearchTest.cpp -Iinclude 
...
build/test_GPPSOTest.o : test/GPPSOTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -fPIC -o build/test_GPPSOTest.o -c test/GPPSOTest.cpp -Iinclude 
build/test_GPSingleFunctionOptTest.o : test/GPSingleFunctionOptTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -O3 -fPIC -o build/test_GPSingleFunctionOptTest.o -c test/GPSingleFunctionOptTest.cpp -Iinclude 

ALL_INCLUESgpsuit.out= include/math/carryGroup2.h include/math/AbstractPoint.h include/math/carryTree.h include/math/carryArray.h include/math/carryPoint.h include/math/GPSingleTree.h include/math/FormulaTree.h include/optimizor/GPOptimizorFactory.h include/optimizor/GPGoldenDivideOpt.h include/optimizor/IGPOptimizor.h include/optimizor/GPNetSearchOpt.h include/optimizor/GPParticleSwarmOpt.h include/system/system_lib.h include/evolution/GPFunctionFitcomputer.h include/evolution/GPEvolutionGroup.h include/evolution/IGPADFOptimizor.h include/evolution/GPADFOptimizorFactory.h include/evolution/GPSingleOptimizor.h include/core/xmlGPDataLoader.h include/core/GPFactory.h include/core/GPFunctionDataBase.h include/core/GPStatusContent.h include/core/genetic_operator.h include/core/GP_XmlString.h include/core/IDataBase.h include/core/BasicComposeFunction.h include/core/function.h include/core/GPData.h include/core/IGPAutoDefFunction.h include/core/group.h include/core/GPProducer.h include/xml/xmlReader.h include/xml/xmlTree.h include/producer/GPTreeProducer.h include/producer/GPTreeADF.h include/producer/GPGraphicProducer.h include/producer/GPGraphicADF.h include/utils/statusMachine.h include/utils/AutoStorage.h include/utils/RefCount.h include/utils/AutoClean.h include/utils/BasicTree.h include/utils/debug.h include/utils/GP_Clock.h include/utils/GPRandom.h include/head.h include/user/status.h include/user/IFunctionTable.h include/user/package.h
...
example.out:  build/simple_main.o libGP.so
	g++  -O3 -fPIC -o example.out  build/simple_main.o ./libGP.so -ldl -lpthread ${SELF_VARIABLES}
build/simple_main.o : simple_main.cpp libGP.so  ${ALL_INCLUESexample.out}
	g++ -O3 -fPIC -o build/simple_main.o -c simple_main.cpp -Iinclude 
