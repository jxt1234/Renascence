...
build/test_AbstractPointTest.o : test/AbstractPointTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_AbstractPointTest.o -c test/AbstractPointTest.cpp -Iinclude -Ithird
  
build/test_GPAPITest.o : test/GPAPITest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPAPITest.o -c test/GPAPITest.cpp -Iinclude -Ithird
  
build/test_GPBasicPiecesFunctionCreatorTest.o : test/GPBasicPiecesFunctionCreatorTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPBasicPiecesFunctionCreatorTest.o -c test/GPBasicPiecesFunctionCreatorTest.cpp -Iinclude -Ithird
  
build/test_GPcarryGroupTest.o : test/GPcarryGroupTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPcarryGroupTest.o -c test/GPcarryGroupTest.cpp -Iinclude -Ithird
  
build/test_GPCarryVaryGroupTest.o : test/GPCarryVaryGroupTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPCarryVaryGroupTest.o -c test/GPCarryVaryGroupTest.cpp -Iinclude -Ithird
  
build/test_GPFormulaADFTest.o : test/GPFormulaADFTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPFormulaADFTest.o -c test/GPFormulaADFTest.cpp -Iinclude -Ithird
  
build/test_GPFormulaTreeTest.o : test/GPFormulaTreeTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPFormulaTreeTest.o -c test/GPFormulaTreeTest.cpp -Iinclude -Ithird
  
build/test_GPFrontEndProducerTest.o : test/GPFrontEndProducerTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPFrontEndProducerTest.o -c test/GPFrontEndProducerTest.cpp -Iinclude -Ithird
  
build/test_GPGoldenDividerTest.o : test/GPGoldenDividerTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPGoldenDividerTest.o -c test/GPGoldenDividerTest.cpp -Iinclude -Ithird
  
build/test_GPMultiLayerTreeTest.o : test/GPMultiLayerTreeTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPMultiLayerTreeTest.o -c test/GPMultiLayerTreeTest.cpp -Iinclude -Ithird
  
build/test_GPNetSearchTest.o : test/GPNetSearchTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPNetSearchTest.o -c test/GPNetSearchTest.cpp -Iinclude -Ithird
  
build/test_GPParallelTest.o : test/GPParallelTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPParallelTest.o -c test/GPParallelTest.cpp -Iinclude -Ithird
  
build/test_GPPiecesFunctionFactoryTest.o : test/GPPiecesFunctionFactoryTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPPiecesFunctionFactoryTest.o -c test/GPPiecesFunctionFactoryTest.cpp -Iinclude -Ithird
  
build/test_GPPSOTest.o : test/GPPSOTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPPSOTest.o -c test/GPPSOTest.cpp -Iinclude -Ithird
  
build/test_GPSearchIOTest.o : test/GPSearchIOTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPSearchIOTest.o -c test/GPSearchIOTest.cpp -Iinclude -Ithird
  
build/test_GPSingleParallelMachineTest.o : test/GPSingleParallelMachineTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPSingleParallelMachineTest.o -c test/GPSingleParallelMachineTest.cpp -Iinclude -Ithird
  
build/test_GPSingleTreeTest.o : test/GPSingleTreeTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPSingleTreeTest.o -c test/GPSingleTreeTest.cpp -Iinclude -Ithird
  
build/test_GPStreamADFTest.o : test/GPStreamADFTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPStreamADFTest.o -c test/GPStreamADFTest.cpp -Iinclude -Ithird
  
build/test_GPStreamTest.o : test/GPStreamTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPStreamTest.o -c test/GPStreamTest.cpp -Iinclude -Ithird
  
build/test_GPSystemTest.o : test/GPSystemTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPSystemTest.o -c test/GPSystemTest.cpp -Iinclude -Ithird
  
build/test_GPTest.o : test/GPTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPTest.o -c test/GPTest.cpp -Iinclude -Ithird
  
build/test_GPTestMain.o : test/GPTestMain.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPTestMain.o -c test/GPTestMain.cpp -Iinclude -Ithird
  
build/test_GPThreadParallelTest.o : test/GPThreadParallelTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPThreadParallelTest.o -c test/GPThreadParallelTest.cpp -Iinclude -Ithird
  
build/test_GPTreeProducerTest.o : test/GPTreeProducerTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPTreeProducerTest.o -c test/GPTreeProducerTest.cpp -Iinclude -Ithird
  
build/test_GPXmlEvolutionTest.o : test/GPXmlEvolutionTest.cpp libGP.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -g -fPIC -o build/test_GPXmlEvolutionTest.o -c test/GPXmlEvolutionTest.cpp -Iinclude -Ithird
