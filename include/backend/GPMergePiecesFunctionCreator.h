...
******************************************************************/
#ifndef BACKEND_GPMERGEPIECESFUNCTIONCREATOR_H
#define BACKEND_GPMERGEPIECESFUNCTIONCREATOR_H
...
class GPMergePiecesFunctionCreator:public GPPiecesFunctionCreator
{
public:
    virtual GPPiecesFunction* vCreateFromFuncTree(const GPFunctionTree* tree, const IParallelMachine* machine) const;
    GPMergePiecesFunctionCreator();
    virtual ~GPMergePiecesFunctionCreator();
};
#endif
